 ...
 <div class="humberger__menu__wrapper">
     ...
     <p><a href="profile" style="color:rgb(100, 100, 100);"><i class="fa fa-dashboard"></i> &nbsp &nbsp Dashboard</a></p>
         ...
         <div class="row">
             ...
             <div class="col-lg-9">
                 <nav class="header__menu">
                     <ul>
                         <li class="active"><a href="../" style="color: rgba(100, 100, 100) !important;"><i class="fa fa-home"></i> Home</a></li>
                         <li><a href="profile" style="color: rgba(100, 100, 100) !important;"><i class="fa fa-dashboard"></i> Dashboard</a></li>
                         <li><a href="../contact-us" style="color: rgba(100, 100, 100) !important;"><i class="fa fa-envelope"></i> Contact Us</a></li>
                         <li><a href="../logout" style="color: rgba(100, 100, 100) !important;"><i class="fa fa-user"></i> Logout</a></li>
