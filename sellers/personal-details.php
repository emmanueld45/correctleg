...
<body>
    ...
    <div class="mobile-view-container" style="background-color:;height:100%;">
        ...
        <div class="fixed-head sticky-top">
            <i class="fa fa-angle-left back-btn"></i> Personal Details
        </div>
        <!-- header end -->
        ...
        <div class="form-container">
            <form action="" method="POST">
                ...
                <div style="width:100%;padding:0px;display:flex;flex-flow: row nowrap;">
                    <input type="text" class="form-control col-sm-6 col-xs-6" name="firstname" style="margin-right:7px !important;" value="<?php echo get_seller_detail($sessionid, "firstname"); ?>" placeholder="">
                    <input type="text" class="form-control col-sm-6 col-xs-6" name="lastname" style="" value="<?php echo get_seller_detail($sessionid, "lastname"); ?>" placeholder="">
                </div>
                <br>

                <label>Email Address</label>
                <input type="email" class="form-control" name="email" value="<?php echo get_seller_detail($sessionid, "email"); ?>">
                <br>
                <label>Phone No.</label>
                <input type="tel" class="form-control" name="phone" value="<?php echo get_seller_detail($sessionid, "phone"); ?>">
                ...
                <div style="width:100%;display:flex;justify-content:center;margin-bottom:100px;">
                    <button type="submit" class="save-address-btn" name="submit">Save details</button>
                </div>
    ...
    <div class="desktop-view-container">
        ...
        <div class="row main-area-container">
            ...
            <div class="col-sm-8">
                ...
                <div style="width:100%;padding:10px;font-weight:600;font-size:20px;">PERSONAL DETAILS</div>
                <!-- start of address container -->
                <div class="form-container">
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "UPDATE sellers SET firstname='$firstname', lastname='$lastname', email='$email', phone='$phone' WHERE uniqueid='$sessionid';";
        $update = mysqli_query($conn, $sql);

        if ($update) {
            echo '<script>
window.location.href="personal-details.php?details_updated=true";
</script>';
        } else {
            echo '<script>
        window.location.href="personal-details.php?error=true";
</script>';
        }
    }
    ?>
