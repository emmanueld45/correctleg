...
<body>
    ...
    <div class="title">LOGIN SELLER ACCOUNT</div>
    ...
    <div class="form-container">
        ...
        <form action="" method="POST">
            ...
            <div style="width:100%;display:flex;flex-flow:row nowrap;border:1px solid #ced4da;;border-radius:.25rem;">
                <div style="width:90%;">
                    <input type="password" name="password" class="form-control password" style="border:none;" placeholder="" required>
                </div>
            ...
            <div style="width:100%;text-align:center;padding:10px;font-size:13px;">Forgot password? <a href="recover-password" style="color:crimson;">Click here</a></div>
        ...
        if (!$result) {
            ...
            if ($numrows != 0) {
                ...
                if (PASSWORD_VERIFY($password, $hashed)) {
                    ...
                    echo '<script>
                window.location.href="login?incorrect_password";
                </script>';
                }
            } else {
                echo '<script>
                window.location.href="login?email_does_not_exist";
                </script>';
            }
        }
