...
<body>
    ...
    <div class="mobile-view-container">
        ...
        <div class="nav-btns-container">
            <a href="clearance-sales-select.php" class="nav-btns">Select</a>
            <a href="clearance-sales-added.php" class="nav-btns active">Items Added</a>
        ...
        <div class="order-container">
            ...
            ?>
                            ...
                            <div class="order-box">
                                ...
                                <div class="order-box-right">
                                    ...
                                    <button class="btn btn-danger remove-btn remove-btn<?php echo $row['uniqueid']; ?>" id="<?php echo $row['uniqueid']; ?>" itemimage="../<?php echo $row['image1']; ?>" style="float:right;">remove</button>
                                    <button class="btn removed-btn<?php echo $row['uniqueid']; ?>" style="display:none;background-color:white;border:1px solid grey;color:grey;border-radius:3px;float:right;">removed <i class="fa fa-times"></i></button>
                                </div>
                            </div>
            ...
            <?php
                    ...
                    if ($x == 0) {
                        ...
                        <div style='width:100%;padding:10px;text-align:center;font-size:19px;color:grey'>No item has been added to clearance sale yet!
                        <br>Try again later
                        </div>
...
<br>Try again later
    ...
    <script>
        $(".remove-btn").click(function() {
            var remove_from_clearance_item = "yes";
            ...
            $.ajax({
                ...
                async: false,
                data: {
                    remove_from_clearance_item: remove_from_clearance_item,
                    item_id: item_id
                },
