...
<body>
    ...
    <div class="mobile-view-container">
        ...
        <div class="fixed-head sticky-top">
            <i class="fa fa-angle-left back-btn"></i> Orders (ACTIVE)
        </div>
        <!-- header end -->

        <!-- start of nave btns container-->
        <div class="nav-btns-container">
            <a href="active-orders" class="nav-btns active">Active</a>
            <a href="settled-orders" class="nav-btns">Settled</a>
        ...
        <div class="order-container">
            ...
            ?>
                        ...
                        <div class="order-box">
                            ...
                            <div class="order-box-right">
                                ...
                                <span style="color:crimson;font-size:14px;font-weight:600;"><span style='color:grey'>Item price:</span> <span>&#8358</span><?php echo number_format($row['price']); ?> </span><br>
                                <span style="color:crimson;font-size:14px;font-weight:600;"><span style='color:grey'>Total purchased:</span> <span>&#8358</span><?php echo number_format($row['price'] * $row['howmany']); ?> </span><br>
                                <span style="color:crimson;font-size:14px;font-weight:600;"><span style='color:grey'>Commission:</span> <span>&#8358</span><?php echo number_format($admin->calcItemCommission($row['price']) * $row['howmany']); ?> </span>
            ...
            <?php
                ...
                if ($x == 0) {
                    ...
                    <div style='width:100%;padding:10px;text-align:center;font-size:19px;'>You have no <span style='color:crimson;'>active</span> order yet!</div>
    ...
    <div class="desktop-view-container">
        ...
        <div class="row main-area-container">
            ...
            <div class="col-sm-8">
                ...
                <div style="width:100%;padding:10px;font-weight:600;font-size:20px;">MY ORDERS (ACTIVE)</div>
