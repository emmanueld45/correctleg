    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Clearance sales</h1>
                ...
                <div style="width:100%;height:70px;">
                    ...
                    if (clearance_sale_is_on()) {
                        echo "<a href='clearance-sales-handler.php?action=turnoff' class='btn btn-danger' style='float:;'>Turn Off</a>";
                    }
                    ?>
                </div>

                <?php
                $sql1 = "SELECT * FROM clearancesale;";
                ...
                ?>
                    ...
                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-shopping-cart mr-1"></i>Clearance sales items
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="clearance-sales-handler.php?action=remove_item&item_id=<?php echo $row['uniqueid']; ?>" class="btn btn-danger">remove</a></td>
                                        ...
                                        <div style='width:100%;padding:10px;text-align:center;font-size:60px;color:lightgrey'>No item on clearance sale yet!</div>
                                        </div>";
                                        }
                                        ?>
                ...
                <?php
                    ...
                    <div style='width:100%;padding:10px;text-align:center;font-size:19px;color:grey'>Clearance sale has not been activated for now!
                    <br><br>
                    <a href='clearance-sales-handler.php?action=turnon' class='btn btn-success'>Turn On?</a>
                    </div>
...
clearance sales <span class='alert-link'>successfully turned off!</span>
</div>";
    }
    ?>
    ...
    if (isset($_GET['item_removed'])) {
        echo "<div class='alert alert-danger' style='position:fixed;top:0px;right:10px;z-index:10000;'>
<span class='alert-link'>item removed!</span>
</div>";
    }
    ?>
...
clearance sales <span class='alert-link'>turned on!</span>
</div>";
    }
    ?>
