        ...
        <main>
            <div class="container-fluid">
                ...
                <div class="switch-btns-container">
                    ...
                    <a href="wholesale-settled-orders.php" class="switch-btns active" style="width:30%;">Settled</a>
                    <a href="wholesale-cancelled-orders.php" class="switch-btns" style="width:30%;">Cancelled</a>
                </div>
                ...
                <?php
                $sql = "SELECT * FROM wholesaleorders WHERE status='Settled';";
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        ...
                                        <div style='width:100%;padding:10px;text-align:center;font-size:60px;color:lightgrey'>No Settled Orders yet!</div>
                                        </div>";
                                    }
                                    ?>
