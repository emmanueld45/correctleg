        ...
        <main>
            <div class="container-fluid">
                ...
                <div class="switch-btns-container">
                    <a href="exclusive-items.php" class="switch-btns" style="width:50%;">Added items</a>
                    <a href="select-exclusive-items.php" class="switch-btns  active" style="width:50%;">Select</a>
                </div>
                ...
                <?php
                $sql = "SELECT * FROM product WHERE status='active' AND price>=10000;";
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><a href="exclusive-items-handler.php?add_item=true&item_id=<?php echo $row['uniqueid']; ?>" class="btn btn-success">Add</a></td>
                                    ...
                                    <?php
                                        ...
                                        <div style='width:100%;padding:10px;text-align:center;font-size:60px;color:lightgrey'>No item yet!</div>
                                        </div>";
                                    }
                                    ?>
