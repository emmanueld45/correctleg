            ...
            <div class="container-fluid">
                ...
                <div class="details-container">
                    ...
                    <div style="width:100%;display:flex;justify-content:center;">
                        ...
                        if ($image1 != "empty") {
                            echo "  <img src='../$image1' class='image'>";
                        }


                        if ($image2 != "empty") {
                            echo "  <img src='../$image2' class='image'>";
                        }


                        if ($image3 != "empty") {
                            echo "  <img src='../$image3' class='image'>";
                        }
                    ...
                    <div class="card" style="margin-top:10px;">
                        <div class="card-header" style="font-weight:600;">ITEM DETAILS</div>
                        <div class="card-body">
                            ...
                            <label>Price: </label>
                            <p><?php echo "<span>&#8358</span>" . number_format($row['price']); ?></p>
