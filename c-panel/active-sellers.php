...
<body class="sb-nav-fixed">
        ...
        <main>
            <div class="container-fluid">
                ...
                <div class="switch-btns-container">
                    <a href='active-sellers.php' class="switch-btns active" style="width:50%;">Active</a>
                    <a href='inactive-sellers.php' class="switch-btns" style="width:50%;">In-active</a>
                </div>
                ...
                <?php
                $sql = "SELECT * FROM sellers WHERE status='active';";
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><a href="sellers-handler.php?deactivate_seller=true&seller_id=<?php echo $row['uniqueid']; ?>" class="btn btn-danger">Deactivate</a></td>
                                    ...
                                    <?php
                                        ...
                                        <div style='width:100%;padding:10px;text-align:center;font-size:60px;color:lightgrey'>No Active sellers yet!</div>
                                        </div>";
                                    }
                                    ?>
    ...
    <?php
    if (isset($_GET['seller_deactivated'])) {
        echo "<div class='alert alert-danger' style='position:fixed;top:0px;right:10px;z-index:10000;'>
seller <span class='alert-link'>successfully deactivated!</span>
</div>";
    }
    ?>
