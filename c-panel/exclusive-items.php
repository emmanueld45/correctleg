    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid">
                <h1 class="mt-4">Exclusive items</h1>
                ...
                <div class="switch-btns-container">
                    <a href="exclusive-items.php" class="switch-btns active" style="width:50%;">Added items</a>
                    <a href="select-exclusive-items.php" class="switch-btns" style="width:50%;">Select</a>
                </div>
                ...
                <?php
                $sql = "SELECT * FROM product WHERE status='active' AND exclusive='yes';";
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <i class="fas fa-shopping-cart mr-1"></i>Exclusive items
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><a href="exclusive-items-handler.php?remove_item=true&item_id=<?php echo $row['uniqueid']; ?>" class="btn btn-danger">remove</a></td>
                                    ...
                                    <?php
                                        ...
                                        <div style='width:100%;padding:10px;text-align:center;font-size:60px;color:lightgrey'>No Exclusive item items yet!</div>
                                        </div>";
                                    }
                                    ?>
...
item has been <span class='alert-link'> removed from Exclusive!</span>
</div>";
    }
    ?>
...
item has been <span class='alert-link'> added to Exclusive!</span>
</div>";
    }
    ?>
