        ...
        <main>
            <div class="container-fluid">
                ...
                <div class="switch-btns-container">
                    <a href="active-orders.php" class="switch-btns active" style="width:30%;">Active</a>
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <i class="fas fa-envelope mr-1"></i>Active Orders
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                                <?php
                                                if ($row['adminnew'] == "yes") {
                                                    echo "<tr style='background-color:royalblue;color:white;'>";
                                                } else {
                                                    echo "<tr>";
                                                }
                                                ...
                                                <td>
                                                    <?php
                                                    if ($row['adminnew'] == "yes") {
                                                        echo "<a href='active-orders?mark_as_seen=true&order_id=" . $row['orderid'] . "' class='btn btn-info' style='display:inline-block'>Seen?</a>";
                                                    } else {
                                                        echo "<a href='active-orders?mark_as_unseen=true&order_id=" . $row['orderid'] . "' class='btn btn-info' style='display:inline-block;background-color:#eee;border:1px solid lightgrey;color:grey;font-size:13px;'>seen <i class='fa fa-check'></i></a>";
                                                    }
                                                    ?>
                                                </td>
                                                </tr>
