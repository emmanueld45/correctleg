...
<body>
    ...
    <div class="mobile-view-container" style="background-color:;height:100%;">
        ...
        <div class="fixed-head sticky-top">
            <i class="fa fa-angle-left" onclick="go_back()"></i> Change Password
        </div>
        <!-- header end -->
    ...
    if (isset($_POST['submit'])) {
        $hashed = get_customer_detail($sessionid, "password");
        ...
        if (PASSWORD_VERIFY($password, $hashed)) {
            ...
            if ($newpassword == $repeatpassword) {
                ...
                $sql = "UPDATE customers SET password='$new_hashed' WHERE uniqueid='$sessionid';";
