...
<body>
    ...
    <div class="mobile-view-container" style="">
        ...
        <div class="fixed-head sticky-top">
            <i class="fa fa-angle-left back-btn"></i> Saved Items <i class="fa fa-heart" style="color:white;"></i>
        </div>
        <!-- header end -->
        ...
        <div class="order-container">
            ...
            <?php
            $sql = "SELECT * FROM savedproducts WHERE customerid='$sessionid' ORDER BY id DESC;";
    ...
    <div class="desktop-view-container">
        ...
        <div class="row main-area-container">
            ...
            <div class="col-sm-8">
                ...
                <div style="width:100%;padding:10px;font-weight:600;font-size:20px;">SAVED ITEMS <i class="fa fa-heart" style="color:grey;"></i></div>
                <!-- start of order container -->
                <div class="order-container">
