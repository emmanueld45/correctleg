...
<body>
    ...
    <section class="product-details spad" style="margin-top:-10px;padding:0px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__pic">
                        <div class="product__details__pic__item">
                            <img class="product__details__pic__item--large main-image" modal_main_image_index="1" src="<?php echo get_item_detail($item_id, "image1"); ?>" alt="" style="transition:1s ease;">
                        </div>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="product__details__text" style="height:auto !important;">
                        ...
                        <span><span style="color:black;font-weight:600;font-size:19px;">Size:</span> <?php echo $product->getDetail($item_id, "size"); ?></span><br>
                        ...
                        <div class="p-2"><?php echo get_item_detail($item_id, "description"); ?></div>
                        ...
                        ?>
                            <div class="product-variation-container">
                                <div class="title">Select Size Variation: <br></div>
                                <div class="error variation-error-display"></div>
                                <?php
                                while ($variation_row = mysqli_fetch_assoc($variation_result)) {
                                    if ($variation_row['quantity'] != 0) {
                                        echo "<div class='box variation-btn' variation_price='" . $variation_row['price'] . "' variation_size='" . $variation_row['size'] . "'  variation_quantity='" . $variation_row['quantity'] . "'>" . $variation_row['size'] . "</div>";
                                    }
                                }
                                ?>
                                <br>
                        ...
                        <div class="product__details__quantity">
                            <div class="quantity">
                                <div class="pro-qty">
                                    <input type="text" class="howmany" value="1" readonly>
                                </div>
                            </div>
                        </div>
                        <button class="primary-btn add-to-cart-btn" style="border:none;" id="<?php echo $product->getDetail($item_id, "uniqueid"); ?>" itemname="<?php echo $product->getDetail($item_id, "name"); ?>" itemsize="<?php echo $product->getDetail($item_id, "size"); ?>" itemprice="<?php echo $price; ?>" itemimagesrc="<?php echo $product->getDetail($item_id, "image1"); ?>">ADD TO CART <i class="fa fa-shopping-cart"></i></button>
                        ...
                        <ul>
                            ...
                            <?php
                            if ($product->getDetail($item_id, "brandname") != "empty") {
                                echo "<li><b>Brand</b> <span>" . $product->getDetail($item_id, "brandname") . " </span></li>";
                            }
                ...
                ?>
                    <section class="product-rating-container">
                        <div class="title-container">
                            Product Rating & Reviews <i class="fa fa-angle-right open-product-rating-modal-btn"></i>
                        </div>
                        <div class="body-container">
                            ...
                            ?>
                                <div class="box">
                                    <div class="">
                                        <?php echo $product->displayReviewStars($row['number_of_stars'], "<i class='fa fa-star star active'></i>", "<i class='fa fa-star star'></i>"); ?>
                                    </div>
                                    <div class="comment">
                                        <?php echo $row['comment']; ?>
                                    </div>
                                    <div class="name">by <?php echo $customer->getDetail($row['customer_id'], "firstname"); ?></div>
                                    <span class="date"> <?php echo $row['date']; ?></span>
                                    <span class="purchase-tag"><i class="fa fa-check-circle"></i> Verified Purchase</span>
                            ...
                            if ($numrows > 5) {
                                echo "  <div class='see-all-container'>
                                    <a class='see-all-btn open-product-rating-modal-btn'>See All Reviews <i class='fa fa-angle-right'></i></a>           
                            </div>";
                            }
                            ?>
                        </div>
                ...
                <!-- product rating modal container start --->
                <section class="product-rating-modal-container">
                    <div class="title-container">
                        Product Rating & Reviews <i class="fa fa-times close-product-rating-modal-btn"></i>
                    </div>
                    <div class="body-container">
                        <?php
                        $result = $db->setQuery("SELECT * FROM product_reviews WHERE product_id='$item_id' AND status='Active';");
                ...
                <!-- product rating modal container end --->
            ...
            <div class="component-container related-products-carousel owl-carousel owl-theme">
                ...
                ?>
                        <a href="product?i=<?php echo $row1['uniqueid']; ?>" class="box">
                            ...
                            <div class="stars-container">
                                <?php
                                echo $product->getStars($row1['uniqueid'], "<i class='fa fa-star active' style='color:orange;font-size:14px;'></i>", "<i class='fa fa-star' style='color:lightgrey;font-size:14px;'></i>");
                                ?>
                            </div>
                ...
                ?>
                    <a href="product?i=<?php echo $row['uniqueid']; ?>" class="box">
                        ...
                        <div class="stars-container">
                            <?php
                            echo $product->getStars($row['uniqueid'], "<i class='fa fa-star active' style='color:orange;font-size:14px;'></i>", "<i class='fa fa-star' style='color:lightgrey;font-size:14px;'></i>");
                            ?>
                        </div>
                        <div class="product-price">
    ...
    <div class="bottom-add-to-cart-container">
        ...
        <button class="bottom-add-to-cart-btn add-to-cart-btn" id="<?php echo get_item_detail($item_id, "uniqueid"); ?>" itemname="<?php echo get_item_detail($item_id, "name"); ?>" itemprice="<?php echo get_item_detail($item_id, "price"); ?>" itemsize="<?php echo $product->getDetail($item_id, "size"); ?>" itemimagesrc="<?php echo get_item_detail($item_id, "image1"); ?>">Add to cart <i class="fa fa-shopping-cart"></i></button>
    </div>
    <!-- bottom add to cart container -->
    ...
    <script>
        ...
        $(".open-product-rating-modal-btn").click(function() {
            $(".product-rating-modal-container").fadeIn();
        })
        $(".close-product-rating-modal-btn").click(function() {
            $(".product-rating-modal-container").fadeOut();
        })
        ...
        var variation_size = "";
        var variation_price = "";
        var variation_quantity = "";

        var item_have_variation = "<?php if ($product->productHaveVariation($item_id)) {
                                        echo "yes";
                                    } else {
                                        echo "no";
                                    }; ?>";
        ...
        $(".variation-btn").click(function() {
            ...
            variation_size = $(this).attr("variation_size")
            variation_price = $(this).attr("variation_price")
            formatted_variation_price = new Intl.NumberFormat().format(variation_price)
            variation_quantity = $(this).attr("variation_quantity")
            console.log(variation_size, variation_price, variation_quantity)
            $(".product-variation-container .details").html(`Size: <span class=''>${variation_size}</span>, Price: <span>&#8358</span><span class=''>${formatted_variation_price}</span>`);
