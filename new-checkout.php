...
<body>
            ...
            <div class="checkout-custom-box mt-3">
                ...
                <div class="body">
                    <div class="payment-method-container">
                        <div class="box">
                            <input type="radio" name='payment_method' class="pay-online"> Pay Online
                            <div class="info">Make online payment Make online payment Make online payment</div>
                        </div>

                        <div class="box">
                            <input type="radio" name='payment_method' class="pay-on-delivery"> Pay on Delivery
                            <div class="info">Make online payment Make online payment Make online payment</div>
                        </div>
                    </div>
                </div>
            ...
            <div class="checkout-custom-box">
                ...
                <div class="body">
                    ...
                    <section class="modify-cart-btn-container">
                        <a href="new-cart" class="modify-cart-btn">MODIFY CART</a>
                    </section>
                </div>
            </div>
    ...
    if (isset($_POST['change_address'])) {
        ...
        if ($customer->haveShippingAddress($session_id)) {
            ...
            $admin->goToPage("new-checkout", "address_changed");
        } else {
            $status = "default";
            ...
            $admin->goToPage("new-checkout", "address_created");
        }
    }
    ?>
    ...
    <!-- <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#changeAddressModal">
        Open modal
    </button> -->
    ...
    <script>
        ...
        $(".place-order-btn").click(function() {
            if (have_shipping_address == "yes") {
                if ($(".pay-online").prop("checked") || $(".pay-on-delivery").prop("checked")) {
